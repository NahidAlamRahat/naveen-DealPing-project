...
import 'controller/business_forgot_verify_otp_controller.dart';

class BusinessForgotVerifyOtpScreen extends StatelessWidget {
  const BusinessForgotVerifyOtpScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion(
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          child: GetBuilder<BusinessForgotVerifyAccountController>(
              init: BusinessForgotVerifyAccountController(),
              builder: (controller) {
                return Padding(
