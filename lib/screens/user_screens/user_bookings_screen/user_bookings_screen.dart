...
//                   child: TabBarView(
//                     children: [
//                       PastBookings(controller: controller),
//                     ],
//                   ),
//
//                 ),
...
//       5,
//       (index) => {
//             'title': 'Mirchi Dance Bar447',
//             'location': 'Dhanmondi, Dhaka8',
//             'distance': '2.30 miles',
//             'image': AppImagePath.bookingsImage,
//           });
//
//   BookingsList({super.key, required this. bookingModel});
//
//   @override
//   Widget build(BuildContext context) {
//     return Expanded(
...
//       5,
//       (index) => {
//             'title': 'Mirchi Dance Bar2',
//             'location': 'Dhanmondi, Dhaka2',
//             'distance': '2.3 miles',
//             'image': AppImagePath.bookingsImage,
//           });
//
//   PastBookings({super.key, required this.controller});
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return BookingCard(
              ...
              location: booking.address,
              distance: "${booking.distance.toStringAsFixed(2)} miles",
             imagePath: '${AppImagePath.imageUrl}${booking.userProfileImage}' ?? ''
...
class BookingCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    print("Image URL:❤️❤️❤️❤️❤️ $imagePath");
    return Container(
      margin: const EdgeInsets.symmetric(vertical: 8),
      padding: const EdgeInsets.all(8),
      decoration: BoxDecoration(
        ...
        Expanded( // ✅ fix: wrap with Expanded
          child: Row(
            children: [
              ...
              const SpaceWidget(spaceWidth: 6),
              Expanded( // ✅ wrap the Column to avoid internal overflow
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    TextWidget(
