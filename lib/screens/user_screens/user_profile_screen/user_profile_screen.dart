        ...
        child: Column(
          ...
          children: [
            ...
            _buildMenuItem(
              ...
              title: 'About Us',
              onTap: () {
                // Navigate to About Us screen (placeholder)
                ScaffoldMessenger.of(context).showSnackBar(
            ...
            _buildMenuItem(
              ...
              onTap: () {
                // Navigate to Terms and Conditions screen (placeholder)
                ScaffoldMessenger.of(context).showSnackBar(
            ...
            _buildMenuItem(
              ...
              title: 'Password',
              onTap: () {
                // Navigate to Password screen (placeholder)
                ScaffoldMessenger.of(context).showSnackBar(
            ...
            _buildMenuItem(
              ...
              title: 'FAQ',
              onTap: () {
                // Navigate to FAQ screen (placeholder)
                ScaffoldMessenger.of(context).showSnackBar(
