...
import 'package:deal_ping/screens/business_screens/business_auth_screens/business_sign_up_screen/controller/business_sign_up_controller.dart';
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  GetBuilder<UserSignUpButtonController>(
                    builder: (signUpController) {
                      return Visibility(
                        visible: signUpController.isLoading == false,
                        replacement: const Center(child: CircularProgressIndicator()),
                        child: ButtonWidget(
                          onPressed: signUpController.onTapSignUpButton, // ✅ নাম সঠিক করলাম
