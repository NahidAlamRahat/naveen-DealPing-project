...
//   print(
//             "Timer: ${remainingSeconds.value} seconds remaining");
//  // Debugging
//       } else {
...
class UserSignupVerifyAccountController extends GetxController {
  ...
  int remainingSeconds = 180; // 2.5 minutes
  var canResend = false.obs;
  bool isLoading = false; // ✅ now normal bool
  late String email;
  late Timer _timer;
  ...
  String formatTime() {
    ...
    final remainingSec = remainingSeconds % 60;
    return '${minutes.toString().padLeft(2, '0')}:${remainingSec.toString().padLeft(2, '0')}';
  }
