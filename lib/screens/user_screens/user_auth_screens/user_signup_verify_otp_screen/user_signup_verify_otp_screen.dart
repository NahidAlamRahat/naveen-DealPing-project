...
import 'controller/user_signup_verify_otp_controller.dart';

class UserSignupVerifyOtpScreen extends StatelessWidget {
  const UserSignupVerifyOtpScreen({super.key});
    ...
    return AnnotatedRegion(
      ...
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          child: SafeArea(
            child: GetBuilder<UserSignupVerifyAccountController>(
                init: UserSignupVerifyAccountController(),
                builder: (controller) {
                  return Padding(
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          GetBuilder<UserSignupVerifyAccountController>(
                            builder: (controllers) {
                              return Visibility(
