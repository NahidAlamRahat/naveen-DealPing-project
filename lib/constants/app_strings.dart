class AppStrings {
  ...
  // Onboarding Screen
  static const String onboardingTitle = "Request a last-minute\nreservation";
  static const String onboardingDescription =
      "It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially";
  static const String user = "Start as an User";
  static const String business = "Start as a Business";
  ...
  // User Chat Screen
  static const String bookYourTable = "Book Your Table";

  // User Booking Summary Screen
  ...
  static const String areYouSure = "Are You Sure you want to cancel booking?";
